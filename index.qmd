...
![](figures/2025-warning.excalidraw.svg)

::: notes
and not just on our minds at posit, but I think for a lot of us, 2025 was the year AI for data science got seriously convenient, and so sparked a lot of concerns about correctness
:::
...
::: notes
for simon and i and the rest of the ai team at posit, it was on our minds especially because of a new agent we released right before posit conf called databot
...
::: notes
but it felt so powerful and so new that we essentially released it under a warning label
- this is the image from a blog post joe and i wrote about Databot, and This was actually one of the first things I worked on the AI team. 
...
::: notes
for us who make statistical software and use it, the mission is not to explore the universe but....
...
but think about this simple example: when your coding agent presents a command and asks you to approve it, how often do you carefully read it? and how often do you just hit accept?

[possible active learning anecdote]
:::
