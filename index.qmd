...
<svg class="convenience-correctness rounded" viewBox="0 0 1200 680" role="img" aria-labelledby="no-code-closed-source-title">
  ...
  <use href="#convenience-correctness-base" />
  <circle class="quadrant-point" cx="740" cy="500" r="11" />
  <text class="quadrant-point-label" x="764" y="500">No-code / closed-source</text>
</svg>

## {.paper-slide .quadrant-slide}

<svg class="convenience-correctness rounded" viewBox="0 0 1200 680" role="img" aria-labelledby="coding-agent-quadrants-title">
  <title id="coding-agent-quadrants-title">Convenience and correctness axes with coding agents slightly more convenient and slightly less correct than no-code and closed-source tools</title>
  <use href="#convenience-correctness-base" />
  <circle class="quadrant-point" cx="740" cy="500" r="11" />
  <text class="quadrant-point-label" x="764" y="500">No-code / closed-source</text>
  <circle class="quadrant-point" cx="880" cy="545" r="11" />
  <text class="quadrant-point-label" x="904" y="545">Coding agent</text>
</svg>
...
<svg class="convenience-correctness rounded" viewBox="0 0 1200 680" role="img" aria-labelledby="databot-quadrants-title">
  <title id="databot-quadrants-title">Convenience and correctness axes with R in RStudio in the upper-left quadrant, no-code and closed-source tools in the lower-right quadrant, and Databot slightly above the origin</title>
  <use href="#convenience-correctness-base" />
  <circle class="quadrant-point" cx="400" cy="145" r="11" />
  <text class="quadrant-point-label" x="376" y="145" text-anchor="end">R in RStudio</text>
  <circle class="quadrant-point" cx="740" cy="500" r="11" />
  ...
  <circle class="quadrant-point" cx="880" cy="545" r="11" />
  <text class="quadrant-point-label" x="904" y="545">Coding agent</text>
  <circle class="quadrant-point" cx="600" cy="285" r="11" />
  <text class="quadrant-point-label" x="624" y="285">Databot</text>
</svg>
...
<svg class="convenience-correctness rounded" viewBox="0 0 1200 680" role="img" aria-labelledby="posit-assistant-quadrants-title">
  <title id="posit-assistant-quadrants-title">Convenience and correctness axes with Posit Assistant as correct as R in RStudio and more convenient</title>
  <use href="#convenience-correctness-base" />
  <circle class="quadrant-point" cx="400" cy="145" r="11" />
  <text class="quadrant-point-label" x="376" y="145" text-anchor="end">R in RStudio</text>
  <circle class="quadrant-point" cx="740" cy="500" r="11" />
  ...
  <circle class="quadrant-point" cx="600" cy="285" r="11" />
  <text class="quadrant-point-label" x="624" y="285">Databot</text>
  <circle class="quadrant-point" cx="650" cy="145" r="11" />
  <text class="quadrant-point-label" x="674" y="145">Posit Assistant</text>
</svg>
...
<svg class="convenience-correctness rounded" viewBox="0 0 1200 680" role="img" aria-labelledby="commons-quadrants-title">
  <title id="commons-quadrants-title">Convenience and correctness axes with commons as correct as Posit Assistant and more convenient</title>
  <use href="#convenience-correctness-base" />
  <circle class="quadrant-point" cx="400" cy="145" r="11" />
  <text class="quadrant-point-label" x="376" y="145" text-anchor="end">R in RStudio</text>
  <circle class="quadrant-point" cx="740" cy="500" r="11" />
  ...
  <text class="quadrant-point-label" x="624" y="285">Databot</text>
  <circle class="quadrant-point" cx="650" cy="145" r="11" />
  <text class="quadrant-point-label" x="660" y="170">Posit Assistant</text>
  <circle class="quadrant-point" cx="840" cy="145" r="11" />
  <text class="quadrant-point-label" x="864" y="145">commons</text>
</svg>
