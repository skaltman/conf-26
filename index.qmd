...
the next day, a data scientist checked their analysis, noticed the mistake. not only do they notice the problem, they already have a couple functions in an internal package that would have carried out the analysis correctly for the vp.
:::
...
It's an open source R and Python package built on `ellmer` / `chatlas` and `shinychat`.
:::
