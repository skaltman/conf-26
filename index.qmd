...
Make it less bad when it is wrong [**by signaling trust**]{.fragment} [**and feedback loops**]{.fragment}
:::
...
A data scientist builds the agent in an IDE, encoding trusted calculations and context.
:::
...
The data scientist reviews its behavior, moving responses up the trust ladder.
:::
:::
