...
It would be easy to call what she was doing lazy or dismiss it as slop. But there is another way to look at it: she had a meaningful questions that she wanted answered, and she reached for the tool that she thought would give her those answers.
...
::: notes
but you can't stop there and assume that just because a human is present and technically "in the loop" you've solved the issue of correctness asked to verify something

because this is not how people work--its not how expertise work, its not how human decision making works. you can't assume a human expert will automatically transfer expertise to an agent system just by being "in the loop"

and so I like to call this simplistic division of labor the "slap a human on it" approch 

and there's lot of evidence that this won't work! but to convince you for now I just want you to think about this:

when your coding agent (or past coding agents) show you a command and ask you to approve it, how often do you carefully read that command, and how often do you just hit accept?
...
All of that is still true. I stand by it. it's inspirational! I would love want to avoid being misled by confident but incorrect claims. 
...
our implicit strategy, not said out right but what we were all kind of thinking, was: read the code

and I not only don't think anyone did that in the way we had in mind, but also that this is not a good correctness strategy!

it relies too much on the hard work of the user, in an interface not conducive to reading (as code is streaming past them or being put into files faster than they could have imaged), but also because reading in that way is not a great way to form a mental model of a complex topic. 
...
furthermore, the presence of the agent changes how people will make decisions
:::

# The system has to engage your expertise

::: notes
The problem is not that people lack expertise. The problem is that expertise does not apply itself merely because an expert is present.

There is a lot of research on this: automation bias, approval fatigue, passive versus active learning, how trust is mediated, and how human decision-making is shaped by environmental and social factors.

The agent, the interface, the timing and amount of information, cognitive load, and the cues the system provides all affect how someone makes a decision.

A human is not a fixed safety component. The interaction determines whether and how their expertise becomes part of the work.
:::
...
<br>is expertise or correctness encoded into the agent itslef
<br>
* **How does the interaction support trustworthy work?**
:::

::: notes
So the important question is not simply who checks the output. It is how we design the interaction so that the human and the agent together can produce trustworthy work.

That does not make human expertise less important. It takes that expertise seriously enough to design for how it will actually be used.
:::
...
::: notes
That gives us two responsibilities. We need to improve what the agent does, and we need to design the interaction around what happens when it still makes mistakes.
:::
