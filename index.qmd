...
[but add additional people who might want to vibe analyze, à la Joe]
...
* Help the model not be wrong **by adding trusted code**
* Make it less bad when it is wrong **by signaling uncertainty and setting up feedback loops**

# 

[show diagram of HITL/SaHoi]

# 

[show commons diagram, but only at a high level]
