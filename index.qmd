...
> ::: {.fragment}
> _The complexity of the data processes and of the computations applied to them mean that those who receive the results of modern data analysis have limited opportunity to verify the results by direct observation._
> ::: 
>
> ::: {.fragment}
...
>
> ::: {.fragment}
> _...This places an obligation on all creators of software to program is such a way that the computations can be understood and trusted. This obligation I label the_ Prime Directive.
> ::: 
