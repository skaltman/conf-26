...
[Built with commons]{style="display: block; margin-top: 20px; font-size: 34px; font-weight: 500; opacity: 0.8;"}
:::
...
::: notes
with vibe analysis, it's not just that the answers might be wrong, or that you can't tell how they were arrived at
it's also that we might just kind of tolerate this shift in correctness
this was always a problem and we've always made tools that push you towards correctness
but it's now incredibly easy to get a wrong-looking answer that has the feel and ephemera of a right one
:::
...
::: notes
and I think we find this really motivating
AI has expanded who can get answers from data
and that changes the infrastructure we need for correct, transparent, and reproducible analysis
we care about correctness, know that you still need to be able to trace how an answer was arrived at and reproduce it
and so we make tools for that
with commons specifically, we want data teams to be able to hand someone who otherwise would have done a vibe analysis a commons agent and have them not feel a loss in convenience and get a boost in correctness.

we need all of you data people to build that infrastructure
commons is the package that can help you do that
:::
