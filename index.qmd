...
and there's a lot of research on this! from automation bias, to approval fatigue, to passive vs active learning, to how trust is mediated, to the fact that human decision-making is not a fixed process by one shaped constantly by shifting environmental and social factors

but instead of all that, I think I can convince you of my point with a simple example: when your coding agent presents a command and asks you to approve it, how often do you carefully read it? and how often do you just hit accept?

[when anthropic did this, they found...the presence of a human is not enough. need to design for the interaction]

the presence of a human -- no matter how skilled -- is not enough

telling someone to be there and stay vigilant is not a correctness strategy
:::
