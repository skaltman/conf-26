...
# {#databot .paper-slide .databot-demo-slide}

<video class="rounded click-to-toggle" width="100%" data-autoplay muted loop playsinline preload="auto" tabindex="0" aria-label="Databot demo. Plays automatically without sound; click to pause or resume.">
  <source src="figures/databot-demo.mp4" type="video/mp4">
</video>

<div class="databot-demo-title">Databot (2025)</div>
...
<video class="rounded click-to-toggle" style="max-height: 550px; max-width: 100%; height: auto;" data-autoplay muted preload="auto" tabindex="0" aria-label="Canvas demo. Plays automatically; click to pause or resume.">
  <source src="figures/canvas-zoomed.mp4" type="video/mp4">
</video>
