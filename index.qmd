...
## {.blue-slide .posit-assistant-blue-slide}
...
:::notes
Let's revisit those lessons learned on agent-building from Sara. She said we ought to Help the agent be correct, and make it less bad when it is wrong.
...
# But what if the user is not a data scientist? {.blue-slide}
